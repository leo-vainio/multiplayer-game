...
SPACESHIP_WIDTH, SPACEWHIP_HEIGHT = 55, 45
...
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACEWHIP_HEIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACEWHIP_HEIGHT)), 270)
...
def main():
    yellow = pygame.Rect(100, 300, SPACESHIP_WIDTH, SPACEWHIP_HEIGHT)
    red = pygame.Rect(1000, 300, SPACESHIP_WIDTH, SPACEWHIP_HEIGHT) # x, y, w, h
